    ...
    public ExportResult generateExportFiles(View screen, String projectName,
        ...
        if (globalCssLogicFile.exists()) {
            ...
            try {
                ...
                globalCssLogic.fromJson(logicJson);
                String baseRules = globalCssLogic.generateBaseCssRules();
                String pseudoRules = globalCssLogic.generateCssPseudoRules();
                String asdCss = globalCssLogic.generateAsdSource("css");
                if (baseRules != null && !baseRules.trim().isEmpty()) {
                    accumulatedCssBuffer.append("\n/* Global Stylesheet Styles */\n").append(baseRules).append("\n");
                }
                if (pseudoRules != null && !pseudoRules.trim().isEmpty()) {
                    accumulatedCssBuffer.append("\n/* Global Stylesheet Interaction Rules */\n").append(pseudoRules).append("\n");
                }
                if (asdCss != null && !asdCss.trim().isEmpty()) {
                    accumulatedCssBuffer.append("\n/* Global Stylesheet ASD CSS */\n").append(asdCss).append("\n");
                }
            } catch (Exception e) {
                Log.w("ExportManager", "Error parsing global CSS blocks: " + e.getMessage());
            }
        }
        ...
        try {
            ...
            if (projectId != null && !projectId.isEmpty()) {
                try {
                    ...
                    writeFile(extCssFile, finalCssContent);
